• [![MATLAB](https://github.com/bcpocha/ci-configuration-examples/actions/workflows/
ci.yml/badge.svg)](https://github.com/bcpocha/ci-configuration-examples/actions/
workflows/ci.yml)
